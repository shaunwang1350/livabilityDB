...
export default function AlbumsPage() {
  ...
  return (
    // TODO (TASK 22): replace the empty object {} in the Container attribute sx with flexFormat. 
    // Observe the change to the Albums page. Then uncomment the code to display the cover image and once again observe the change, 
    // i.e. what happens to the layout now that each album card has a fixed width?
