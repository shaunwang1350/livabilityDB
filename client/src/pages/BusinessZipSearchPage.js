      ...
      <Container>
        <Box mt={35} mb={3} p={3} sx={{ background: 'black', borderRadius: '16px', boxShadow: 24}} >
          ...
          <Box m={1} display="flex" justifyContent="flex-end" alignItems="flex-end" >
            <Button variant="outlined" onClick={() => businessZipSearchRoute()} sx={{ height: 40 }} >
              {" "}Search{" "}
            </Button>
          </Box>
        </Box>
        ...
        {businessInfo && (
          <Box mt={3} mb={3} p={3} sx={{ background: "black", borderRadius: "16px" }} >
            <Typography variant="h5" fontWeight={800} mb={2}>Bar chart for number of stars and reviews</Typography>
            <Divider />
            <BarChart
              width={800}
              height={600}
